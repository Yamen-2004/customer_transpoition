...
class shamal extends StatefulWidget {
  const shamal({super.key});

  @override
  _shamal createState() => _shamal();
}

class _shamal extends State<shamal> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('مجمع  الشمال'),
      ),
      body: FutureBuilder(
        future: tasks,
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            data = snapshot.data![0].point2;
            point2 = data;
