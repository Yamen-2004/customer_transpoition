...
class zarqaapoints extends StatefulWidget {
  const zarqaapoints({super.key});

  @override
  _zarqaapoints createState() => _zarqaapoints();
}

class _zarqaapoints extends State<zarqaapoints> {
  List pictures = [
  ...
  List names = [
    "مجمع الامير راشد",
    "مجمع الملك عبدالله الثاني",
    
  ];
  List routes = ["/zarqaaPoint1",
                 "/zarqaaPoint2"];
  @override
